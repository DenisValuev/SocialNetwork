    ...
    public class UserMenuView
    {
        ...
        public void Show(User user)
        {
            while (true)
            {
                ...
                Console.WriteLine("Посмотреть информацию о моём профиле (нажмите 1)");
                Console.WriteLine("Редактировать мой профиль (нажмите 2)");
                Console.WriteLine("Добавить в друзья (нажмите 3)");
                Console.WriteLine("Просмортеть список друзей(нажмите 4)");
                ...
                switch (keyValue)
                {
                    ...
                    case "4":
                        {
                            Program.friendUserView.Show(user.UserFriends);
                            break;
                        }
                    case "5":
                        {
